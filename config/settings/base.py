...
# african_cities_conference/
APPS_DIR = ROOT_DIR / "african_cities_conference"
env = environ.Env()
...
LOCAL_APPS = [
    ...
    "african_cities_conference.home.apps.HomeConfig",
]
...
MIGRATION_MODULES = {"sites": "african_cities_conference.contrib.sites.migrations"}
